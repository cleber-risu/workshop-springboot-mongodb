...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, criarInstantGMT(2018, 3, 21, 12, 0), "Partiu viagem", "Vou viajar para São Paulo. Abraços!", maria);
		Post post2 = new Post(null, criarInstantGMT(2018, 3, 23, 12, 0), "Bom dia", "Acordei feliz hoje!", maria);
